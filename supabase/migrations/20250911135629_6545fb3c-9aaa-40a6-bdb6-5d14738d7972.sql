...
-- Inserir algumas sessões de atendimento exemplo
...
-- Inserir algumas imagens médicas exemplo
...
-- Inserir alguns consentimentos digitais
...
-- Sucesso! Banco de dados populado com dados de exemplo
RAISE NOTICE 'Banco de dados populado com sucesso!';
RAISE NOTICE '- 2 organizações criadas';
RAISE NOTICE '- 3 clínicas criadas';
RAISE NOTICE '- 3 fabricantes de equipamento';
RAISE NOTICE '- 3 fornecedores';
RAISE NOTICE '- 6 equipamentos';
RAISE NOTICE '- 8 produtos';
RAISE NOTICE '- 3 prestadores de serviços';
RAISE NOTICE '- 3 templates de procedimentos';
RAISE NOTICE '- 6 prontuários';
RAISE NOTICE '- 3 sessões de atendimento';
RAISE NOTICE '- 3 imagens médicas';
RAISE NOTICE '- 3 consentimentos digitais';