-- Remover tipos que podem ter sido criados parcialmente
DO $$ 
BEGIN
    DROP TYPE IF EXISTS especialidade_medica CASCADE;
    DROP TYPE IF EXISTS categoria_produto CASCADE;
    DROP TYPE IF EXISTS tipo_equipamento CASCADE;
    DROP TYPE IF EXISTS status_produto CASCADE;
    DROP TYPE IF EXISTS status_equipamento CASCADE;
    DROP TYPE IF EXISTS tipo_movimentacao CASCADE;
    DROP TYPE IF EXISTS tipo_manutencao CASCADE;
    DROP TYPE IF EXISTS status_manutencao CASCADE;
    DROP TYPE IF EXISTS tipo_prestador CASCADE;
EXCEPTION
    WHEN OTHERS THEN NULL;
END $$;

-- Remover tabelas que podem ter sido criadas parcialmente
DROP TABLE IF EXISTS public.uso_equipamentos CASCADE;
DROP TABLE IF EXISTS public.manutencoes_equipamento CASCADE;
DROP TABLE IF EXISTS public.equipamentos CASCADE;
DROP TABLE IF EXISTS public.fabricantes_equipamento CASCADE;
DROP TABLE IF EXISTS public.movimentacao_estoque CASCADE;
DROP TABLE IF EXISTS public.produtos CASCADE;
DROP TABLE IF EXISTS public.fornecedores CASCADE;
DROP TABLE IF EXISTS public.prestadores_servicos CASCADE;
