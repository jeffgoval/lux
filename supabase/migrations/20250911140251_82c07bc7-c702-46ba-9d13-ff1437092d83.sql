-- Popular banco de dados com dados de exemplo - Versão corrigida
-- Removendo referências a usuários inexistentes nos campos criado_por

-- 1. ORGANIZAÇÕES (sem criado_por pois é obrigatório)
...
-- 9. PRONTUÁRIOS (com criado_por obrigatório)
...
-- 10. SESSÕES DE ATENDIMENTO (com criado_por obrigatório)
...
-- 11. IMAGENS MÉDICAS (com criado_por obrigatório)
...
-- 12. CONSENTIMENTOS DIGITAIS (com criado_por obrigatório)
