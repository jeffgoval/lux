-- Corrigir templates padrão - remover constraint NOT NULL temporariamente
ALTER TABLE public.templates_procedimentos ALTER COLUMN criado_por DROP NOT NULL;

-- Inserir templates padrão para procedimentos com UUID fictício
