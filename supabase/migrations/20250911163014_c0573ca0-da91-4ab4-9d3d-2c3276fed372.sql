...
-- Criar tabela de roles disponíveis no sistema (versão simplificada sem RLS complexo)
...
-- Política simples para visualização - todos usuários autenticados podem ver roles ativas
